...
STATUS_MESSAGES = ["My name is Bond, James Bond", "Shaken, not stirred"]      #import datetime library

print "Hello! Let's get started"                         #first display message

choice = raw_input("Do you want to continue as a default user. Press Y/N: ") #Start of spy application
